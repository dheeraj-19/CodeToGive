...
import { test } from 'components/BackendFunction';
...
export default ({ roundedHeaderButton }) => {
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    setTestimonial(<CircleLoader size={150} />)
    const test_text = {
      text: text,
      language: language
    }
  ...
  return (
      ...
      <Header roundedHeaderButton={roundedHeaderButton} />
        <TwoColumn>
          <LeftColumn>
            <Heading>
            Text <span tw="text-primary-500">Translation</span>
            </Heading>
            <Paragraph>
              This tool is easy to setup, understand, and use.
            </Paragraph>
